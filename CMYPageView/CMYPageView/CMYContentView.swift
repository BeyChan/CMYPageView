...
@objc protocol CMYContentViewDelegate: class {
    func contentView(_ contentView: CMYContentView, progress: CGFloat, sourceIndex: Int, targetIndex: Int)
    
    @objc optional func contentViewEndScroll(_ contentView: CMYContentView)
}

private let kContentCellID = "kContentCellID"

class CMYContentView: UIView {
    
    // MARK: 对外属性
    weak var delegate: CMYContentViewDelegate?
...
extension CMYContentView: UICollectionViewDataSource {
...
extension CMYContentView: UICollectionViewDelegate {
